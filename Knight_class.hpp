#ifndef KNIGHT_CLASS_HPP
#define KNIGHT_CLASS_HPP
#include "rule_class.hpp"


class Knight: public Piece {
public:
    Knight(char color, char letter_pos, int cipher_pos): Piece(color, letter_pos, cipher_pos, Piece::KNIGHT) {}
    ...
    void move(Board* board, char targetLetterPos, int targetCipherPos) override {
        ...
        board_pieces[targetCipherPos-1][targetLetterPos-'A'] = new Knight(getColor(), targetLetterPos, targetCipherPos);
